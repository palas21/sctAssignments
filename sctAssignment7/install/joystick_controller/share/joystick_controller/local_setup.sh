...
: ${AMENT_CURRENT_PREFIX:="/home/palas21/dev/git/sctAssignments/sctAssignment7/install/joystick_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/joystick_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/joystick_controller/environment/path.sh"
